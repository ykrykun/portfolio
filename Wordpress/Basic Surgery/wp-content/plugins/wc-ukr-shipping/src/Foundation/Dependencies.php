...
use kirillbdev\WCUkrShipping\NovaPoshta\Address\CloudAddressProvider;
        ...
        return [
            ...
            AddressProviderInterface::class => function ($container) {
                return $container->make(
                    (int)get_option(WCUS_OPTION_CLOUD_CONNECTED, 0) === 1
                        ? CloudAddressProvider::class
                        : MySqlAddressProvider::class
                );
            },
            // Modules
