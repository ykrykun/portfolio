...
// define('AGS_DIVI_SHOP_BUILDER_ADDONS_URL', 'https://divi.space/wp-content/uploads/product-addons/divi-ecommerce.json');
...
if ( defined('AGS_DIVI_SHOP_BUILDER_ADDONS_URL') ) {
	...
	add_action('admin_menu', function() {
		add_menu_page( 'Addons Test', 'Addons Test', 'manage_options', 'ags-divi-shop-builder-addons', [ 'AGS_Product_Carousel_Addons', 'outputList' ] );
	});
	*/
