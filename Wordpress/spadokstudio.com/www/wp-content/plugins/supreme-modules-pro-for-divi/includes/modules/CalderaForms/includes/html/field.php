...
$html_template = '';
// magics!
$syncer         = Caldera_Forms_Sync_Factory::get_object(
	$form,
	$field,
	Caldera_Forms_Field_Util::get_base_id( $field, null, $form )
);
...
if ( $sync ) {
	...
	echo '<div class="dsm-cf-html ' . esc_attr( $field['config']['custom_class'] ) . '">' . et_core_intentionally_unescaped( $content, 'html' ) . '</div>';
}
