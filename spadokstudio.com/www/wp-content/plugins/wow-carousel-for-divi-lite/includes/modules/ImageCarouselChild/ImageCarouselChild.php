...
class WDCL_ImageCarouselChild extends WDCL_Builder_Module {
	...
	public function get_fields() {
		...
		$content = $this->_custom_advanced_background_fields( 'content', 'Content', 'advanced', 'content', array( 'color', 'gradient' ) );
		$overlay = $this->_get_overlay_option_fields( 'overlay', array() );
